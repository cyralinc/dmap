...
// PostgresRepository is a SQLRepository implementation for Postgres databases.
...
// PostgresRepository implements SQLRepository
var _ SQLRepository = (*PostgresRepository)(nil)
...
// Postgres-specific table sample query. See SQLRepository.SampleTable and
