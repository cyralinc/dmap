...
// Introspect provides a mock function with given fields: ctx, params
func (_m *MockRepository) Introspect(ctx context.Context, params IntrospectParameters) (*Metadata, error) {
	...
	var r0 *Metadata
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, IntrospectParameters) (*Metadata, error)); ok {
		return rf(ctx, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, IntrospectParameters) *Metadata); ok {
		r0 = rf(ctx, params)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, IntrospectParameters) error); ok {
		r1 = rf(ctx, params)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockRepository_Expecter) Introspect(ctx interface{}, params interface{}) *MockRepository_Introspect_Call {
	return &MockRepository_Introspect_Call{Call: _e.mock.On("Introspect", ctx, params)}
}

func (_c *MockRepository_Introspect_Call) Run(run func(ctx context.Context, params IntrospectParameters)) *MockRepository_Introspect_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(IntrospectParameters))
	})
	return _c
}
...
func (_c *MockRepository_Introspect_Call) RunAndReturn(run func(context.Context, IntrospectParameters) (*Metadata, error)) *MockRepository_Introspect_Call {
	_c.Call.Return(run)
	return _c
}
...
// SampleTable provides a mock function with given fields: ctx, params
func (_m *MockRepository) SampleTable(ctx context.Context, params SampleParameters) (Sample, error) {
	ret := _m.Called(ctx, params)
	...
	var r0 Sample
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, SampleParameters) (Sample, error)); ok {
		return rf(ctx, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, SampleParameters) Sample); ok {
		r0 = rf(ctx, params)
	} else {
		r0 = ret.Get(0).(Sample)
	}

	if rf, ok := ret.Get(1).(func(context.Context, SampleParameters) error); ok {
		r1 = rf(ctx, params)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockRepository_Expecter) SampleTable(ctx interface{}, params interface{}) *MockRepository_SampleTable_Call {
	return &MockRepository_SampleTable_Call{Call: _e.mock.On("SampleTable", ctx, params)}
}

func (_c *MockRepository_SampleTable_Call) Run(run func(ctx context.Context, params SampleParameters)) *MockRepository_SampleTable_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(SampleParameters))
	})
	return _c
}
...
func (_c *MockRepository_SampleTable_Call) RunAndReturn(run func(context.Context, SampleParameters) (Sample, error)) *MockRepository_SampleTable_Call {
	_c.Call.Return(run)
	return _c
}
