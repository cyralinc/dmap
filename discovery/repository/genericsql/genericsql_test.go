...
func Test_Introspect_IsSuccessful(t *testing.T) {
	...
	expectedMetadata := repository.Metadata{
		Name:     repoName,
		RepoType: repoType,
		Database: database,
		Schemas: map[string]*repository.SchemaMetadata{
			"schema1": {
				Name: "schema1",
				Tables: map[string]*repository.TableMetadata{
					"table1": {
						Schema: "schema1",
						Name:   "table1",
						Attributes: []*repository.AttributeMetadata{
							{
								Schema:   "schema1",
								Table:    "table1",
								Name:     "column1",
