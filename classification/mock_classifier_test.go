...
func (_m *MockClassifier) Classify(ctx context.Context, input map[string]interface{}) (Result, error) {
	...
	var r0 Result
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, map[string]interface{}) (Result, error)); ok {
		return rf(ctx, input)
	}
	if rf, ok := ret.Get(0).(func(context.Context, map[string]interface{}) Result); ok {
		r0 = rf(ctx, input)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(Result)
...
func (_c *MockClassifier_Classify_Call) Return(_a0 Result, _a1 error) *MockClassifier_Classify_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClassifier_Classify_Call) RunAndReturn(run func(context.Context, map[string]interface{}) (Result, error)) *MockClassifier_Classify_Call {
	_c.Call.Return(run)
	return _c
}
