...
func SampleRepository(ctx context.Context, repo SQLRepository, params SampleParameters) (
	[]Sample,
	error,
) {
...
func SampleAllDatabases(
	...
	for _, db := range dbs {
		go func(db string, cfg RepoConfig) {
			...
			// TODO: this is ugly - there's gotta be a better way to do this -ccampo 2024-04-02
