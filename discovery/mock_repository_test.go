...
// MockRepository is an autogenerated mock type for the SQLRepository type
...
func (_c *MockRepository_Introspect_Call) RunAndReturn(
	run func(context.Context) (
		*Metadata,
		error,
	),
) *MockRepository_Introspect_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockRepository_ListDatabases_Call) RunAndReturn(
	run func(context.Context) (
		[]string,
		error,
	),
) *MockRepository_ListDatabases_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockRepository) SampleTable(ctx context.Context, meta *TableMetadata, params SampleParameters) (
	Sample,
	error,
) {
...
func (_e *MockRepository_Expecter) SampleTable(
	ctx interface{},
	meta interface{},
	params interface{},
) *MockRepository_SampleTable_Call {
	return &MockRepository_SampleTable_Call{Call: _e.mock.On("SampleTable", ctx, meta, params)}
}

func (_c *MockRepository_SampleTable_Call) Run(
	run func(
		ctx context.Context,
		meta *TableMetadata,
		params SampleParameters,
...
func (_c *MockRepository_SampleTable_Call) RunAndReturn(
	run func(
		context.Context,
		*TableMetadata,
		SampleParameters,
