...
var (
	...
	// SQLRepository implementations, or just avoid global state altogether, should
...
type RepoConstructor func(ctx context.Context, cfg RepoConfig) (SQLRepository, error)
...
// NewRepository is a factory method to return a concrete SQLRepository
...
func (r *Registry) NewRepository(ctx context.Context, cfg RepoConfig) (SQLRepository, error) {
...
func NewRepository(ctx context.Context, cfg RepoConfig) (SQLRepository, error) {
...
func init() {
	MustRegister(
		RepoTypeDenodo,
		func(_ context.Context, cfg RepoConfig) (SQLRepository, error) {
	...
	MustRegister(
		RepoTypeSnowflake,
		func(ctx context.Context, cfg RepoConfig) (SQLRepository, error) {
