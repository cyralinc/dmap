...
// subset of ANSI SQL compatible databases. Many SQLRepository implementations may
...
// the SQLRepository interface, GenericRepository is meant to be used as a building
// block for other SQLRepository implementations, rather than as a standalone
// implementation. Specifically, the SQLRepository.ListDatabases method is left
...
var _ SQLRepository = (*GenericRepository)(nil)
