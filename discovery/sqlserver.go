...
// SqlServerRepository is a SQLRepository implementation for MS SQL Server
// databases.
type SqlServerRepository struct {
	// The majority of the SQLRepository functionality is delegated to a generic
	// SQL repository instance (genericSqlRepo).
	genericSqlRepo *GenericRepository
}

// SqlServerRepository implements SQLRepository
var _ SQLRepository = (*SqlServerRepository)(nil)
...
// SQL Server-specific table sample query. See SQLRepository.SampleTable and
